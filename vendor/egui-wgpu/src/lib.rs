...
async fn request_adapter(
    ...
    let adapter = instance
        .request_adapter(&wgpu::RequestAdapterOptions {
            ...
            // wgpu 30: opt out of the limit buckets, keeping the adapter's own
            // limits, which is what this crate reported before the field
            // existed.
...
pub fn adapter_info_summary(info: &wgpu::AdapterInfo) -> String {
    let wgpu::AdapterInfo {
        ...
        // wgpu 30. Named rather than `..` so a future field is a compile error
        // here too, which is how this function stays a summary of all of them.
        limit_bucket,
    } = &info;
